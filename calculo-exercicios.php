 ...
 <div class="navbar-wrapper">
           ...
           <nav class="collapse navbar-collapse js-navbar-collapse">
                <ul class="nav navbar-nav  pull-right">
                    <li ><?php echo $textos [$_GET['idioma']]['home-index'];
                        ?></li>
                    <li class="active"><?php echo $textos [$_GET['idioma']]['exercicios'];
                        ?></li>
    ...
    <section class="wrapper">
        <div class="frequencia">
                      ...
                      <center> <h1><?php echo $textos [$_GET['idioma']]['resultado'];
                        ?></h1></center>
                       <hr>
<?php
$nome = $_POST['nome'];
...
$fcmin = (220 - $idade) * 0.60;
$fcmax = (220 - $idade) * 0.75;

?>
    
   <h2><?php echo $textos [$_GET['idioma']]['minima'];
                        ?> </h2> </br>
...
?>
 ...
 <h2><?php echo $textos [$_GET['idioma']]['maxima'];
                        ?></h2> </br>
...
$fcmin = (226 - $idade) * 0.60;
$fcmax = (226 - $idade) * 0.75;
...
<hr>
 <?php echo $textos [$_GET['idioma']]['voltar'];
                        ?>
